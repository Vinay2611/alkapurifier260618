...
class Production extends CI_Controller {
    ...
    public function arealist(){
        ...
        if($this->user_role=="Admin"){
            ...
            $sql = "SELECT f.*,u.id as user_id FROM franchies as f inner join users as u on u.controller_id=f.Id where f.AssociatesType='Area Production Controller' and u.id='$user_id'";
        }
    ...
    public function plantlist(){
       ...
       }elseif($this->user_role=="Plant Production Controller"){
           $sql = "SELECT f.*,u.id as user_id FROM franchies as f inner join users as u on u.controller_id=f.Id where f.AssociatesType='Plant Production Controller' and u.id='$user_id'";
       }else{
    ...
    public function industriallist(){
        ...
        }elseif($this->user_role=="Industrial Production Controller"){
            $sql = "SELECT f.*,u.id as user_id FROM franchies as f inner join users as u on u.controller_id=f.Id where f.AssociatesType='Industrial Production Controller' and u.id='$user_id'";
        }elseif($this->user_role=="Area Production Controller"){
            $sql = "SELECT f.*,u.id as user_id FROM franchies as f inner join users as u on u.controller_id=f.Id where f.AssociatesType='Industrial Production Controller' and u.parent_id IN (SELECT id FROM users where parent_id='$user_id')";
        }elseif($this->user_role=="Plant Production Controller"){
    ...
    public function jobberlist(){
        $user_id=$this->logged_id;
        if($this->user_role=="Admin"){
            $sql = "SELECT f.*,u.id as user_id FROM franchies as f inner join users as u on u.controller_id=f.Id where f.AssociatesType='Production Jobber'";
        }elseif($this->user_role=="Production Jobber"){
            $sql = "SELECT f.*,u.id as user_id FROM franchies as f inner join users as u on u.controller_id=f.Id where f.AssociatesType='Production Jobber' and u.id='$user_id'";
        }elseif($this->user_role=="Area Production Controller"){
            $sql = "SELECT f.*,u.id as user_id FROM franchies as f inner join users as u on u.controller_id=f.Id 
                  where f.AssociatesType='Production Jobber' and u.parent_id IN 
            ...
            $sql = "SELECT f.*,u.id as user_id FROM franchies as f inner join users as u on u.controller_id=f.Id 
                  where f.AssociatesType='Production Jobber' and u.parent_id='$user_id'";
        }
    ...
    public function getChildPlantProductionUser(){
    }
}
