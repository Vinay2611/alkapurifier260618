                        ...
                        <?php if(isset($data)){
                            foreach ($data as $d){
                                ...
                                <tr class="odd gradeX">
                                    ...
                                    <td><a href="<?php echo base_url(); ?>sales/add_sales?id=<?php echo $d["id"];?>" class="btn btn-xs btn-success"><i class="fa fa-edit"></i></a> <a href="javascript:void(0);" class="btn btn-xs btn-danger DeleteRecord" data-id="<?php echo $d['id'];?>"><i class="fa fa-trash"></i></a></td>
                                </tr>
                                <?php
                            }
                        }?>
