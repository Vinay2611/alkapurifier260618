                        ...
                        <?php if(isset($data)){
                            foreach ($data as $d){
                                ...
                                <tr class="odd gradeX">
                                    ...
                                    <td><?php echo $d['FranchiesName']==""?'Admin':$d['FranchiesName'];?></td>
                                    ...
                                    <td><a href="javascript:void(0);" class="btn btn-xs btn-danger DeleteRecord" data-id="<?php echo $d['id'];?>"><i class="fa fa-trash"></i></a></td>
                                </tr>
                                <?php
                            }
                        }?>
