                        ...
                        <?php if(isset($stock)){
                            foreach ($stock as $s){
                                ...
                                <tr class="odd gradeX">
                                    ...
                                    <td><a href="<?php echo base_url(); ?>stock/add_products?id=<?php echo $s["id"];?>" class="btn btn-xs btn-success"><i class="fa fa-edit"></i></a> <a href="javascript:void(0);" class="btn btn-xs btn-danger DeleteRecord" data-id="<?php echo $s['id'];?>"><i class="fa fa-trash"></i></a></td>
                                </tr>
                                <?php
                            }
                        }?>
