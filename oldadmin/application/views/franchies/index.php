                        ...
                        <?php if(isset($franchies)){
                            foreach ($franchies as $f){
                                ...
                                <tr class="odd gradeX">
                                    ...
                                    <td><a href="addfranchies?id=<?php echo $f["Id"];?>" class="btn btn-xs btn-success"><i class="fa fa-edit"></i></a> <a href="javascript:void(0);" class="btn btn-xs btn-danger DeleteRecord" data-id="<?php echo $f['Id'];?>"><i class="fa fa-trash"></i></a></td>
                                </tr>
                                <?php
                            }
                        }?>
