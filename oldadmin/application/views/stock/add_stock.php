                            ...
                            <div class="col-md-6 col-sm-6">
                                ...
                                <select name="product_id" class="form-control product_id" required>
                                    ...
                                    <?php foreach ($products as $p){
                                        ?>
                                        <option <?php echo isset($data->product_id) && $data->product_id==$p['id']?'selected':''; ?> value="<?php echo $p['id']?>"><?php echo $p['product_title']?></option>
                                        <?php
                                    }?>
                                </select>
                            </div>
                    ...
                    <div class="row">
                        <div class="form-group">
                            <div class="col-md-6 col-sm-6">
                                ...
                                <input type="text" class="form-control"  value="<?php echo isset($data->quantity)?$data->quantity:'' ;?>" name="quantity"  placeholder="Quantity" required>
                            </div>
                        </div>
                    </div>
